...
public class NChromosome implements Comparable<NChromosome>, Cloneable {

	List<ClassInfo> chromos; // 染色体表示
	int sizeOfChromos; // 染色体大小，即类的总数
	Double fit;
	
	public NChromosome(List<ClassInfo> listOfGA, boolean isChromos) {
	...
	@Override
	public int compareTo(NChromosome o) {
		//升序排列
