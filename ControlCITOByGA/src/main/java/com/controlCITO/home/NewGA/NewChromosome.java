...
public class NewChromosome implements Comparable<NewChromosome>, Cloneable {

	List<ClassInfo> chromos; // 染色体表示
	int sizeOfChromos; // 染色体大小，即类的总数
	Double fit;
	
	public NewChromosome(List<ClassInfo> listOfGA, boolean isChromos,NewPopulations currentPopulations) {
	...
	public Object clone() {
		NewChromosome o = null;
		try {
			o = (NewChromosome) super.clone();
	...
	@Override
	public int compareTo(NewChromosome o) {
		//升序排列
