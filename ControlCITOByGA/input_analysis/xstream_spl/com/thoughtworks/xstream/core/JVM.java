...
public class JVM implements Caching {
    ...
    private final boolean supportsAWT = false; //chpkim loadClass("java.awt.Color") != null;
    private final boolean supportsSwing = false; // chpkim loadClass("javax.swing.LookAndFeel") != null;
    private final boolean supportsSQL = false; // chpkim  loadClass("java.sql.Date") != null;
